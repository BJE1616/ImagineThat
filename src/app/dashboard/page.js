                    ...
                    {campaign ? (
                        <div className="bg-slate-800 border border-slate-700 rounded-lg p-4 mb-4">
                            <div className="flex items-center justify-between mb-3">
                                ...
                                {getBonusViews() > 0 && (
                                    <span className="px-2 py-1 bg-green-500/20 border border-green-500/50 rounded-full text-green-400 text-xs font-bold animate-pulse">
                                        🎁 +{getBonusViews()} bonus views!
                                    </span>
                                )}
                            </div>
